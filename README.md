## General Description
AlphaPy is a module to make editing and tweaking strings, lists, and dictionaries, easier. This module has many useful function and more will be coming. Here is a list of the ones that are available in AlphaPy version 0.1: 
* alphanum
* numalpha
* caesar_cipher
* morse_code_encoder
